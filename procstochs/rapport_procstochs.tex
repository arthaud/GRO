...
\section{Gare de péage}
  ...
  paramètres des lois de Poisson régissant l'entreé et la sortie.}.
  ...
  \subsection{Simulation sisyphe}
    \subsubsection{Cas d'une file}
      ...
      qu'elles ne partent. Par contre si $\lambda > \mu$ le nombre de voiture
    ...
    \subsubsection{Cas de plusieurs files}
      ...
      Les temps de service ($\frac 1 \mu$) de dépendent du moyen de payement,
      on notera donc $\mu_{cb}$ et $\mu_{e}$.
      todo
