...
Malheureusement, notre algorithme ne fonctionne que dans le cadre des
morpions $3\times *$. En effet, pour de plus grandes tailles, on peut
générer de nombreux carrés magiques différents, un détail auquel nous
n'avions pas songé durant l'UA.
