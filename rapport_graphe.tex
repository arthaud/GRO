...
\section{Méthode de résolution}
  \subsection{Graphes eulériens}
    ...
    \subsubsection{Matrices latines}
      La première méthode est inspirée des matrices latines: une fois la matrice latine du graphe construite, on la multiplie par elle-même $n-1$ fois ($n$ étant le nombre de points du graphe) afin de connaître tous les chemins de % TODO
