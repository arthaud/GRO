...
\section{Problème du sac à dos}
  ...
  \subsection{Résolution exacte}
    ...
    plusieurs instances du problème (cf table~\ref{table:greedy}), et l'algorithme est rapide.
...
retourner (-matrice[0, dernière colonne], à_produire, restes)
    ...
    \subsubsection{Dégénérescence}
      ...
      possibilités aussi intéressantes les unes que les autres. Elle consiste
